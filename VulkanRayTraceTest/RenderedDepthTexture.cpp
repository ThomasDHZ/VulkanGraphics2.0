...
RenderedDepthTexture::RenderedDepthTexture(glm::vec2& TextureResolution, VkImageLayout imageLayout) : Texture(TextureResolution, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage();
    CreateTextureView();
    CreateTextureSampler();
...
RenderedDepthTexture::RenderedDepthTexture(int width, int height, VkImageLayout imageLayout) : Texture(width, height, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage();
    CreateTextureView();
    CreateTextureSampler();
