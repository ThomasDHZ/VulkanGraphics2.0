...
public:
	...
	void AddTexture(VulkanEngine& engine, std::shared_ptr<Texture> texture);
	...
	std::shared_ptr<Texture> GetTexture(unsigned int TextureID) { return TextureList[TextureID]; };
