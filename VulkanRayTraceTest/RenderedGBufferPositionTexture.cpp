...
void RenderedGBufferPositionTexture::CreateTextureImage(std::shared_ptr<VulkanEngine> engine)
{
...
void RenderedGBufferPositionTexture::CreateTextureSampler(std::shared_ptr<VulkanEngine> engine)
{
...
void RenderedGBufferPositionTexture::RecreateRendererTexture(std::shared_ptr<VulkanEngine> engine)
{
    Width = engine->SwapChain.GetSwapChainResolution().width;
    Height = engine->SwapChain.GetSwapChainResolution().height;
