...
Engine::Engine(unsigned int width, unsigned int height, const char* WindowName)
{
   ...
   AssetPtr::SetUpPtr(EnginePtr::GetEnginePtr(), WindowPtr::GetWindowPtr());
   ...
   ObjManagerPtr::SetUpPtr(EnginePtr::GetEnginePtr(), MaterialManagerPtr::GetMaterialManagerPtr(), InputManagerPtr::GetInputManagerPtr(), TextureManagerPtr::GetTextureManagerPtr());
    ...
    gameObject->AddChildModel(AssetPtr::GetAssetPtr()->meshManager, std::make_shared<SparkManStage>(SparkManStage(EnginePtr::GetEnginePtr(), AssetPtr::GetAssetPtr(), glm::vec3(0.0f, 0.0f, 0.0f))));
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(gameObject);

    std::shared_ptr<GameObject> gameObject2 = std::make_shared<GameObject>(GameObject(EnginePtr::GetEnginePtr()));
    gameObject2->AddChildModel(AssetPtr::GetAssetPtr()->meshManager, std::make_shared<Model>(Model(EnginePtr::GetEnginePtr(), AssetPtr::GetAssetPtr()->materialManager, AssetPtr::GetAssetPtr()->textureManager, "../Models/TestAnimModel/model.dae")));
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(gameObject2);

    std::shared_ptr<GameObject> gameObject3 = std::make_shared<GameObject>(GameObject(EnginePtr::GetEnginePtr()));
    gameObject3->AddChildMesh(AssetPtr::GetAssetPtr()->meshManager, std::make_shared<Skybox>(Skybox(EnginePtr::GetEnginePtr(), AssetPtr::GetAssetPtr())));
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(gameObject3);
    ...
    gameObject4->AddChildMesh(AssetPtr::GetAssetPtr()->meshManager, std::make_shared<TerrainMesh>(TerrainMesh(EnginePtr::GetEnginePtr(), "../texture/perlin_noise.png", materialPtr)));
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(gameObject4);
    ...
    AssetPtr::GetAssetPtr()->textureManager->Load3DTexture("C:/Users/dotha/Desktop/detailed_surfaces/media/sculptureSphere.dds", VK_FORMAT_R8_UNORM);
  // assetManager->AddModel(engine, "../Models/viking_room.obj");
    ...
    AssetPtr::GetAssetPtr()->meshManager->AddMesh(std::make_shared<Skybox>(Skybox(EnginePtr::GetEnginePtr(), AssetPtr::GetAssetPtr())));
  ...
  /*   assetManager.AddModel(engine, "../Models/EnemyBeast.fbx");
    ...
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(std::make_shared<GUIPanel>(GUIPanel(EnginePtr::GetEnginePtr(), materialPtr, rectangle, glm::vec2(0.0f))));
    AssetPtr::GetAssetPtr()->ObjManager->ObjectList.emplace_back(std::make_shared<TextMesh>(TextMesh(EnginePtr::GetEnginePtr(), AssetPtr::GetAssetPtr()->materialManager, AssetPtr::GetAssetPtr()->textureManager, AssetPtr::GetAssetPtr()->guiManager->FontList[0], "SparkMan", glm::vec2(0.0f))));

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.dlight.direction = glm::vec4(0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.dlight.ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.dlight.diffuse = glm::vec4(0.5f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.dlight.specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[0].position = glm::vec4(0.5f, 1.0f, 0.3f, 1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[0].ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[0].diffuse = glm::vec4(0.8f, 0.8f, 0.8f, 0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[0].specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[1].position = glm::vec4(0.5f, 1.0f, 0.3f, 1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[1].ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[1].diffuse = glm::vec4(0.8f, 0.8f, 0.8f, 0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[1].specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[2].position = glm::vec4(0.5f, 1.0f, 0.3f, 1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[2].ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[2].diffuse = glm::vec4(0.8f, 0.8f, 0.8f, 0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[2].specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[3].position = glm::vec4(0.5f, 1.0f, 0.3f, 1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[3].ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[3].diffuse = glm::vec4(0.8f, 0.8f, 0.8f, 0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[3].specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[4].position = glm::vec4(0.5f, 1.0f, 0.3f, 1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[4].ambient = glm::vec4(0.2f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[4].diffuse = glm::vec4(0.8f, 0.8f, 0.8f, 0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.plight[4].specular = glm::vec4(1.0f);

    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.sLight.ambient = glm::vec4(0.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.sLight.diffuse = glm::vec4(1.0f);
    AssetPtr::GetAssetPtr()->SceneData->UniformDataInfo.sLight.specular = glm::vec4(1.0f);

    renderer = Renderer(EnginePtr::GetEnginePtr(), WindowPtr::GetWindowPtr(), AssetPtr::GetAssetPtr());
}
...
{
    return AssetPtr::GetAssetPtr()->textureManager->LoadTexture2D(FilePath, format);
}

std::shared_ptr<Material> Engine::LoadMaterial(const std::string& MaterialName, MaterialTexture& material)
{
    return AssetPtr::GetAssetPtr()->materialManager->LoadMaterial(MaterialName, material);
}
...
{
    AssetPtr::GetAssetPtr()->textureManager->LoadCubeMap(CubeMapFiles, VK_FORMAT_R8G8B8A8_UNORM);
}

void Engine::LoadTerrain(const std::string& HeightMapPath, std::shared_ptr<Material> material)
{
    AssetPtr::GetAssetPtr()->meshManager->AddMesh(std::make_shared<TerrainMesh>(TerrainMesh(EnginePtr::GetEnginePtr(), HeightMapPath, material)));
}
