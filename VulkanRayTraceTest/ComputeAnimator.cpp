...
{
	VertexBufferCopy = std::make_shared<VulkanBuffer>(modelList[0].MeshList[0].VertexBuffer);

	descriptorSets = engine.CreateDescriptorSets(descriptorPool, descriptorLayout);

	VkDescriptorBufferInfo VertexBufferInfo = engine.AddBufferDescriptor(modelList[0].MeshList[0].VertexBuffer);
	VkDescriptorBufferInfo MeshDataufferInfo = engine.AddBufferDescriptor(modelList[0].MeshList[0].MeshProperties.VulkanBufferData);
	VkDescriptorBufferInfo TransformDataBufferInfo = engine.AddBufferDescriptor(modelList[0].MeshList[0].TransformBuffer);
