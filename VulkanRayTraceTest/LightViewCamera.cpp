...
LightViewCamera::LightViewCamera(std::shared_ptr<VulkanEngine> engine, glm::vec3 lightPos, glm::vec3 lightview)
{
...
void LightViewCamera::Update(std::shared_ptr<VulkanEngine> engine)
{
	std::cout << "Use other LightViewCamera.Update" << std::endl;
}

void LightViewCamera::Update(std::shared_ptr<VulkanEngine> engine, glm::vec3 lightPos, glm::vec3 lightview)
{
