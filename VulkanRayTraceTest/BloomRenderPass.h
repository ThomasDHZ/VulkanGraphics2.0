...
public:
	...
	static constexpr RenderPassID RendererID = Bloom_Renderer;
	...
	void RebuildSwapChain(VulkanEngine& engine, std::shared_ptr<AssetManager> assetManager, std::shared_ptr<Texture> InputBloomTexture);
