...
void SSAORenderPass::CreateRendererFramebuffers()
{
...
void SSAORenderPass::SetUpCommandBuffers()
{
...
void SSAORenderPass::GenerateKernal(SSAOTextureList& textures)
{
...
void SSAORenderPass::GenerateNoiseTexture(SSAOTextureList& textures)
{
...
void SSAORenderPass::Draw()
{
    ...
    sSAOProperties.projection = AssetManagerPtr::GetAssetPtr()->cameraManager->ActiveCamera->GetProjectionMatrix();
    sSAOProperties.TextureWidth = EnginePtr::GetEnginePtr()->SwapChain.SwapChainResolution.width;
    sSAOProperties.TextureHeight = EnginePtr::GetEnginePtr()->SwapChain.SwapChainResolution.height;
