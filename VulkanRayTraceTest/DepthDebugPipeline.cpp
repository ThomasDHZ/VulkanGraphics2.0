...
DepthDebugPipeline::DepthDebugPipeline(const VkRenderPass& renderPass, std::shared_ptr<Texture> DepthTexture) : GraphicsPipeline()
{
    SetUpDescriptorPool();
...
void DepthDebugPipeline::SetUpDescriptorSets(std::shared_ptr<Texture> DepthTexture)
{
    DescriptorSets = EnginePtr::GetEnginePtr()->CreateDescriptorSets(DescriptorPool, DescriptorSetLayout);

    VkDescriptorImageInfo RenderedTextureBufferInfo = EnginePtr::GetEnginePtr()->AddTextureDescriptor(DepthTexture->View, DepthTexture->Sampler);
...
void DepthDebugPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    ...
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/DepthDebugShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/DepthDebugShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
