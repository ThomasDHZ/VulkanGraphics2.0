...
void SkyboxTextureRenderPass::CreateRenderPass(VulkanEngine& engine)
{
...
void SkyboxTextureRenderPass::CreateRendererFramebuffers(VulkanEngine& engine)
{
...
void SkyboxTextureRenderPass::SetUpCommandBuffers(VulkanEngine& engine)
{
...
void SkyboxTextureRenderPass::Draw(VulkanEngine& engine, std::shared_ptr<AssetManager> assetManager, uint32_t imageIndex)
{
    ...
    assetManager->Draw(CommandBuffer, pbrIrradiancePipeline->ShaderPipelineLayout, assetManager->cameraManager.ActiveCamera);
...
void SkyboxTextureRenderPass::Destroy(VulkanEngine& engine)
{
