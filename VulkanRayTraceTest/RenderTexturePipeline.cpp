...
RenderTexturePipeline::RenderTexturePipeline() : GraphicsPipeline()
{
}

RenderTexturePipeline::RenderTexturePipeline(VulkanEngine& engine, AssetManager& assetManager, std::shared_ptr<SceneDataUniformBuffer> sceneData, const VkRenderPass& renderPass) : GraphicsPipeline()
{
...
RenderTexturePipeline::~RenderTexturePipeline()
{
}

void RenderTexturePipeline::SetUpDescriptorPool(VulkanEngine& engine, AssetManager& assetManager)
{
...
void RenderTexturePipeline::SetUpDescriptorLayout(VulkanEngine& engine, AssetManager& assetManager)
{
    ...
    LayoutBindingInfo.emplace_back(DescriptorSetLayoutBindingInfo{ 10, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT | VK_SHADER_STAGE_MISS_BIT_KHR, assetManager.GetCubeMapBufferDescriptorCount() });
    DescriptorSetLayout = engine.CreateDescriptorSetLayout(LayoutBindingInfo);
}

void RenderTexturePipeline::SetUpDescriptorSets(VulkanEngine& engine, AssetManager& assetManager, std::shared_ptr<SceneDataUniformBuffer> sceneData)
{
...
void RenderTexturePipeline::SetUpShaderPipeLine(VulkanEngine& engine, const VkRenderPass& renderPass)
{
...
void RenderTexturePipeline::UpdateGraphicsPipeLine(VulkanEngine& engine, const VkRenderPass& renderPass)
{
