...
RenderedGTBNTexture::RenderedGTBNTexture() : Texture()
{
}

RenderedGTBNTexture::RenderedGTBNTexture(VulkanEngine& engine, VkImageLayout imageLayout) : Texture(engine, TextureType::vkRenderedTexture, imageLayout)
{
...
RenderedGTBNTexture::RenderedGTBNTexture(VulkanEngine& engine, glm::vec2& TextureResolution, VkImageLayout imageLayout) : Texture(engine, TextureResolution, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage(engine);
    CreateTextureView(engine);
    CreateTextureSampler(engine);
...
RenderedGTBNTexture::RenderedGTBNTexture(VulkanEngine& engine, int width, int height, VkImageLayout imageLayout) : Texture(engine, width, height, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage(engine);
    CreateTextureView(engine);
    CreateTextureSampler(engine);
...
RenderedGTBNTexture::~RenderedGTBNTexture()
{
}

void RenderedGTBNTexture::CreateTextureImage(VulkanEngine& engine)
{
...
void RenderedGTBNTexture::CreateTextureView(VulkanEngine& engine)
{
...
void RenderedGTBNTexture::CreateTextureSampler(VulkanEngine& engine)
{
...
void RenderedGTBNTexture::RecreateRendererTexture(VulkanEngine& engine)
{
    Width = engine.SwapChain.GetSwapChainResolution().width;
    Height = engine.SwapChain.GetSwapChainResolution().height;
