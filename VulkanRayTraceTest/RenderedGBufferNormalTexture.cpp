...
RenderedGBufferNormalTexture::RenderedGBufferNormalTexture(std::shared_ptr<VulkanEngine> engine, VkImageLayout imageLayout) : Texture(engine, TextureType::vkRenderedTexture, imageLayout)
{
...
RenderedGBufferNormalTexture::RenderedGBufferNormalTexture(std::shared_ptr<VulkanEngine> engine, glm::vec2& TextureResolution, VkImageLayout imageLayout) : Texture(engine, TextureResolution, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage(engine);
    CreateTextureView(engine);
    CreateTextureSampler(engine);
...
RenderedGBufferNormalTexture::RenderedGBufferNormalTexture(std::shared_ptr<VulkanEngine> engine, int width, int height, VkImageLayout imageLayout) : Texture(engine, width, height, TextureType::vkRenderedTexture, imageLayout)
{
    CreateTextureImage(engine);
    CreateTextureView(engine);
    CreateTextureSampler(engine);
...
void RenderedGBufferNormalTexture::CreateTextureImage(std::shared_ptr<VulkanEngine> engine)
{
...
void RenderedGBufferNormalTexture::CreateTextureView(std::shared_ptr<VulkanEngine> engine)
{
...
void RenderedGBufferNormalTexture::CreateTextureSampler(std::shared_ptr<VulkanEngine> engine)
{
...
void RenderedGBufferNormalTexture::RecreateRendererTexture(std::shared_ptr<VulkanEngine> engine)
{
    Width = engine->SwapChain.GetSwapChainResolution().width;
    Height = engine->SwapChain.GetSwapChainResolution().height;
