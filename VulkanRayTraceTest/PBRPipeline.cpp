...
PBRPipeline::PBRPipeline(VulkanEngine& engine, AssetManager& assetManager, std::shared_ptr<SceneDataUniformBuffer> sceneData, const VkRenderPass& renderPass) : GraphicsPipeline()
{
...
void PBRPipeline::SetUpDescriptorPool(VulkanEngine& engine, AssetManager& assetManager)
{
...
void PBRPipeline::SetUpDescriptorLayout(VulkanEngine& engine, AssetManager& assetManager)
{
...
void PBRPipeline::SetUpDescriptorSets(VulkanEngine& engine, AssetManager& assetManager, std::shared_ptr<SceneDataUniformBuffer> sceneData)
{
