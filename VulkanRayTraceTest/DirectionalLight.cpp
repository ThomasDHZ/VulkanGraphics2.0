...
{
	auto ao = LightViewCamera(engine, glm::vec3(0.0f, 1.0f, 0.0f), LightBuffer.UniformDataInfo.direction);
...
{
	Light::Update(engine);
	lightViewCamera->Update(engine, glm::vec3(0.0f, 1.0f, 0.0f), LightBuffer.UniformDataInfo.direction);
}
