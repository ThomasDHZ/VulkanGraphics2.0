...
FrameBufferRenderingPipeline::FrameBufferRenderingPipeline(VulkanEngine& renderer, const VkRenderPass& renderPass, VkDescriptorSetLayout layout) : GraphicsPipeline(renderer)
{
	CreateShaderPipeLine(renderer, renderPass, layout);
}
...
void FrameBufferRenderingPipeline::CreateShaderPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass, VkDescriptorSetLayout layout)
{
	...
	FrameBufferPipelineLayoutInfo.pSetLayouts = &layout;
...
void FrameBufferRenderingPipeline::UpdateGraphicsPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass, VkDescriptorSetLayout layout)
{
