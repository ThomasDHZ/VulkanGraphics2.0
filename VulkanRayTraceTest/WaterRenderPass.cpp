...
WaterRenderToTextureRenderPass::WaterRenderToTextureRenderPass(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, std::shared_ptr<SceneDataUniformBuffer> sceneDataptr, std::shared_ptr<UniformData<SkyboxUniformBuffer>> SkyUniformBuffer)
{
...
void WaterRenderToTextureRenderPass::CreateRenderPass(std::shared_ptr<VulkanEngine> engine)
{
...
void WaterRenderToTextureRenderPass::CreateRendererFramebuffers(std::shared_ptr<VulkanEngine> engine)
{
...
void WaterRenderToTextureRenderPass::SetUpCommandBuffers(std::shared_ptr<VulkanEngine> engine)
{
...
void WaterRenderToTextureRenderPass::Draw(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, uint32_t imageIndex, Skybox skybox)
{
...
void WaterRenderToTextureRenderPass::Update(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, SceneDataUniformBuffer& copysceneDataptr, std::shared_ptr<PerspectiveCamera> camera)
{
