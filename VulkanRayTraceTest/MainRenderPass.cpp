...
//
//    pipeline = std::make_shared<ForwardRenderingPipeline>(engine, RenderPass, RenderDrawFlags::RenderAnimated);
//}
//
//MainRenderPass::~MainRenderPass()
//{
...
//
//    pipeline->UpdateGraphicsPipeLine(engine, RenderPass, RenderDrawFlags::RenderAnimated);
//
