...
public:
	...
	VulkanBuffer();
	~VulkanBuffer();
	VkResult CreateBuffer(VkDevice& device, VkPhysicalDevice& physicalDevice, VkDeviceSize BufferSize, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties);
