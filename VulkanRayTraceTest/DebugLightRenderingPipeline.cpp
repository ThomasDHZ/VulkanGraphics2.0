...
DebugLightRenderingPipeline::DebugLightRenderingPipeline(const VkRenderPass& renderPass) : GraphicsPipeline()
{
	SetUpDescriptorPool();
...
void DebugLightRenderingPipeline::SetUpDescriptorPool()
{
...
void DebugLightRenderingPipeline::SetUpDescriptorLayout()
{
...
void DebugLightRenderingPipeline::SetUpDescriptorSets()
{
...
void DebugLightRenderingPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
	std::vector<VkPipelineShaderStageCreateInfo> PipelineShaderStageList;
	PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/LightDebugShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
	PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/LightDebugShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
...
void DebugLightRenderingPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass)
{
