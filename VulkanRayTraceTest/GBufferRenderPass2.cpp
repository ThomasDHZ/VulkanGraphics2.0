...
GBufferRenderPass2::GBufferRenderPass2() : BaseRenderPass()
{
}

GBufferRenderPass2::GBufferRenderPass2(std::shared_ptr<VulkanEngine> engine) : BaseRenderPass()
{
...
void GBufferRenderPass2::CreateRenderPass()
{
...
void GBufferRenderPass2::CreateRendererFramebuffers()
{
...
void GBufferRenderPass2::SetUpCommandBuffers()
{
...
void GBufferRenderPass2::Draw()
{
    ...
    AssetManagerPtr::GetAssetPtr()->Draw(CommandBuffer, renderPassInfo, gBufferPipeline->ShaderPipelineLayout, AssetManagerPtr::GetAssetPtr()->cameraManager->ActiveCamera);
...
void GBufferRenderPass2::RebuildSwapChain()
{
...
void GBufferRenderPass2::Destroy()
{
