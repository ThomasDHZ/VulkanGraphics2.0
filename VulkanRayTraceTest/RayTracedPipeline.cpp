...
void RayTracedPipeline::SetUpPipeline(std::shared_ptr<VulkanEngine> engine)
{
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/raygen.rgen.spv", VK_SHADER_STAGE_RAYGEN_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/miss.rmiss.spv", VK_SHADER_STAGE_MISS_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/shadow.rmiss.spv", VK_SHADER_STAGE_MISS_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/closesthit.rchit.spv", VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/anyhit.rahit.spv", VK_SHADER_STAGE_ANY_HIT_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shader/anyhit1.rahit.spv", VK_SHADER_STAGE_ANY_HIT_BIT_KHR));
