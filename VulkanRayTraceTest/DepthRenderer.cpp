...
void DepthRenderer::Draw()
{
    ...
    AssetManagerPtr::GetAssetPtr()->Draw(CommandBuffer, renderPassInfo, depthPipeline->ShaderPipelineLayout, rendererPassID, AssetManagerPtr::GetAssetPtr()->cameraManager->ActiveCamera);
