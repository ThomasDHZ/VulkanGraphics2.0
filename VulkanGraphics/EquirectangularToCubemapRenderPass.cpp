...
EquirectangularToCubemapRenderPass::EquirectangularToCubemapRenderPass() : BaseRenderPass()
{
}
...
void EquirectangularToCubemapRenderPass::CreateRendererFramebuffers()
{
...
void EquirectangularToCubemapRenderPass::SetUpCommandBuffers()
{
...
void EquirectangularToCubemapRenderPass::RebuildSwapChain(uint32_t cubeMapSize)
{
    CubeMapSize = cubeMapSize;
...
void EquirectangularToCubemapRenderPass::Draw()
{
...
void EquirectangularToCubemapRenderPass::Destroy()
{
    irradiancePipeline->Destroy();
