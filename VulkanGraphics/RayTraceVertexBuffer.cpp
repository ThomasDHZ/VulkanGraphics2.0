...
RayTraceVertexBuffer::RayTraceVertexBuffer()
{
}

RayTraceVertexBuffer::RayTraceVertexBuffer(VulkanEngine& renderer, const std::vector<Vertex>& vertexdata)
{
    ...
    VulkanBufferManager::CreateBuffer(renderer, bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, vertexBuffer, VertexBufferMemory);
...
void RayTraceVertexBuffer::Destory(VulkanEngine& renderer)
{
