...
brdfRenderingPipeline::brdfRenderingPipeline() : GraphicsPipeline()
{
}
...
void brdfRenderingPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    ...
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/BRDFRendererShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/BRDFRendererShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
