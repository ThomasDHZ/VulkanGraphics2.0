...
void Shader2DPipeline::SetUpDescriptorBindings()
{
...
void Shader2DPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    ...
    PipelineShaderStageList.emplace_back(CreateShader("Shaders/Shader2DVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(CreateShader("Shaders/Shader2DFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
