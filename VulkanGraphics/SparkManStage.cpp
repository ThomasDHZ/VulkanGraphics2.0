...
SparkManStage::SparkManStage(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, glm::vec3 Position) : Level2D()
{
	...
	material.DiffuseMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_diffuseOriginal.bmp", VK_FORMAT_R8G8B8A8_SRGB);
	material.SpecularMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_Specular.png", VK_FORMAT_R8G8B8A8_UNORM);
	material.NormalMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_normal.bmp", VK_FORMAT_R8G8B8A8_UNORM);
	material.DepthMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_height.bmp", VK_FORMAT_R8G8B8A8_UNORM);
	material.EmissionMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_Bloom.bmp", VK_FORMAT_R8G8B8A8_UNORM);
	material.AlphaMap = assetManager->textureManager->LoadTexture2D("../texture/SparkMan_Alpha.bmp", VK_FORMAT_R8G8B8A8_UNORM);
	auto loadedmaterial = assetManager->materialManager->LoadMaterial("SparkManMaterial", material);
