...
DebugLightPipeline::DebugLightPipeline() : GraphicsPipeline()
{
}

DebugLightPipeline::DebugLightPipeline(const VkRenderPass& renderPass, std::shared_ptr<RenderedDepthTexture> ShadowMapTexture) : GraphicsPipeline()
{
    SetUpDescriptorPool();
...
DebugLightPipeline::~DebugLightPipeline()
{
}

void DebugLightPipeline::SetUpDescriptorPool()
{
...
void DebugLightPipeline::SetUpDescriptorLayout()
{
...
void DebugLightPipeline::SetUpDescriptorSets(std::shared_ptr<RenderedDepthTexture> ShadowMapTexture)
{
...
void DebugLightPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    std::vector<VkPipelineShaderStageCreateInfo> PipelineShaderStageList;
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("shaders/DebugLightShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("shaders/DebugLightShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
    ...
    pushConstantRange.size = sizeof(ConstLightDebug);
...
void DebugLightPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass, std::shared_ptr<RenderedDepthTexture> ShadowMapTexture)
{
