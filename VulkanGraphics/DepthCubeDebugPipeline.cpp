...
DepthCubeDebugPipeline::DepthCubeDebugPipeline() : GraphicsPipeline()
{
}

DepthCubeDebugPipeline::DepthCubeDebugPipeline(const VkRenderPass& renderPass, std::shared_ptr<RenderedCubeMapDepthTexture> depthTexture) : GraphicsPipeline()
{
    SetUpDescriptorPool();
...
DepthCubeDebugPipeline::~DepthCubeDebugPipeline()
{
}

void DepthCubeDebugPipeline::SetUpDescriptorPool()
{
...
void DepthCubeDebugPipeline::SetUpDescriptorLayout()
{
...
void DepthCubeDebugPipeline::SetUpDescriptorSets(std::shared_ptr<RenderedCubeMapDepthTexture> depthTexture)
{
...
void DepthCubeDebugPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    std::vector<VkPipelineShaderStageCreateInfo> PipelineShaderStageList;
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("shaders/DepthCubeDebugShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("shaders/DepthCubeDebugShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
...
void DepthCubeDebugPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass, std::shared_ptr<RenderedCubeMapDepthTexture> depthTexture)
{
