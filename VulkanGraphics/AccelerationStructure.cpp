...
AccelerationStructure::AccelerationStructure(std::shared_ptr<VulkanEngine> engine)
{
...
void AccelerationStructure::AcclerationCommandBuffer(std::shared_ptr<VulkanEngine> engine, VkAccelerationStructureBuildGeometryInfoKHR& AccelerationStructureBuildGeometryInfo, std::vector<VkAccelerationStructureBuildRangeInfoKHR>& AccelerationStructureBuildRangeInfo)
{
...
void AccelerationStructure::CreateAccelerationStructure(std::shared_ptr<VulkanEngine> engine, VkAccelerationStructureTypeKHR type, VkAccelerationStructureBuildSizesInfoKHR& buildSizeInfo)
{
...
void AccelerationStructure::Destroy(std::shared_ptr<VulkanEngine> engine)
{
