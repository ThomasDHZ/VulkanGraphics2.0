...
DepthCubeMapPipeline::DepthCubeMapPipeline(const VkRenderPass& renderPass, float CubeMapSize) : GraphicsPipeline()
{
    SetUpDescriptorPool();
...
void DepthCubeMapPipeline::SetUpDescriptorSets()
{
...
void DepthCubeMapPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass, float CubeMapSize)
{
