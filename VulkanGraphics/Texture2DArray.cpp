...
Texture2DArray::Texture2DArray(glm::ivec2& TextureResolution) : Texture(TextureResolution, TextureType::vkRenderedTexture)
{
    CreateTextureImage();
    CreateTextureView();
...
Texture2DArray::Texture2DArray(glm::ivec2& TextureResolution, uint32_t layerCount)
{
...
void Texture2DArray::CreateTextureImage()
{
    ...
    TextureInfo.arrayLayers = LayerCount;
    TextureInfo.format = VK_FORMAT_D32_SFLOAT;
    TextureInfo.tiling = VK_IMAGE_TILING_OPTIMAL;
    TextureInfo.initialLayout = (VkImageLayout)ImageLayout;
...
void Texture2DArray::CreateTextureView()
{
...
void Texture2DArray::CreateTextureSampler()
{
...
void Texture2DArray::RecreateRendererTexture(glm::ivec2& TextureResolution, uint32_t layerCount)
{
    Width = TextureResolution.x;
    Height = TextureResolution.y;
