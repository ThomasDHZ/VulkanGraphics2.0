...
SceneToTextureRendererPass::SceneToTextureRendererPass()
{
}

SceneToTextureRendererPass::SceneToTextureRendererPass(VulkanEngine& engine)
{
...
void SceneToTextureRendererPass::CreateRenderPass(VulkanEngine& engine)
{
...
void SceneToTextureRendererPass::CreateRendererFramebuffers(VulkanEngine& engine)
{
...
void SceneToTextureRendererPass::Draw(VulkanEngine& engine, std::vector<VkCommandBuffer>& commandBuffers, int SwapBufferImageIndex, std::vector<std::shared_ptr<Object2D>>& SpriteList)
{
...
void SceneToTextureRendererPass::UpdateSwapChain(VulkanEngine& engine)
{
...
void SceneToTextureRendererPass::Destroy(VulkanEngine& engine)
{
