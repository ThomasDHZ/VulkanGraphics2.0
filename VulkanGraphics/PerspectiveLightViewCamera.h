...
class PerspectiveLightViewCamera : public Camera
{
protected:
    float YAW = -90.0f;
    float PITCH = 0.0f;
...
public:
    ...
    PerspectiveLightViewCamera(std::string Name, glm::vec2 ScreenSize, glm::vec3 position);
    PerspectiveLightViewCamera(std::string Name, glm::vec2 ScreenSize, glm::vec3 position, float pitch, float yaw);
    ~PerspectiveLightViewCamera();
