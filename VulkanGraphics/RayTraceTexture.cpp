...
RayTraceTexture::RayTraceTexture() : Texture()
{
}

RayTraceTexture::RayTraceTexture(VulkanEngine& renderer) : Texture(renderer, TextureType::vkRenderedTexture)
{
...
void RayTraceTexture::CreateTextureImage(VulkanEngine& engine)
{
    VkImageCreateInfo TextureInfo = {};
    TextureInfo.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
    TextureInfo.imageType = VK_IMAGE_TYPE_2D;
    TextureInfo.format = engine.SwapChain.GetSwapChainImageFormat().format;
...
void RayTraceTexture::CreateTextureView(VulkanEngine& engine)
{
    VkImageViewCreateInfo TextureImageViewInfo = {};
    TextureImageViewInfo.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
    TextureImageViewInfo.viewType = VK_IMAGE_VIEW_TYPE_2D;
    TextureImageViewInfo.format = engine.SwapChain.GetSwapChainImageFormat().format;
...
void RayTraceTexture::CreateTextureSampler(VulkanEngine& engine)
{
...
void RayTraceTexture::RecreateRendererTexture(VulkanEngine& engine)
{
