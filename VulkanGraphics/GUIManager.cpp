...
{
	//FontList.emplace_back(std::make_shared<Font>(Font("C:/Users/dotha/source/repos/VulkanGraphics/fonts/Antonio-Regular.ttf")));
}
...
{
	FontList.emplace_back(std::make_shared<Font>(Font(FontLocation)));
}
