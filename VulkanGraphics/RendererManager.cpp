...
void RendererManager::GUIUpdate(std::shared_ptr<VulkanEngine> engine)
{
 ...
 //{
    ...
    {
        GUIChanged |= ImGui::SliderFloat3(("DLight position " + std::to_string(x)).c_str(), &LightManagerPtr::GetLightManagerPtr()->DirectionalLightList[x]->LightBuffer.UniformDataInfo.position.x, -100.0f, 200.0f);
