...
SpotLightDepthRenderPass::SpotLightDepthRenderPass() : BaseRenderPass()
{
}

SpotLightDepthRenderPass::SpotLightDepthRenderPass(uint32_t depthTextureSize) : BaseRenderPass()
{
...
void SpotLightDepthRenderPass::CreateRenderPass()
{
...
void SpotLightDepthRenderPass::CreateRendererFramebuffers()
{
...
void SpotLightDepthRenderPass::RebuildSwapChain(uint32_t depthTextureSize)
{
    RenderPassResolution = glm::ivec2(depthTextureSize, depthTextureSize);
...
void SpotLightDepthRenderPass::Draw()
{
    ...
    for (int x = 0; x < DepthTextureList.size(); x++)
    {
        ...
        AssetManagerPtr::GetAssetPtr()->Draw(RendererType, CommandBuffer[EnginePtr::GetEnginePtr()->CMDIndex], depthPipeline->ShaderPipelineLayout, LightManagerPtr::GetLightManagerPtr()->SpotLightList[x]->lightViewCamera);
