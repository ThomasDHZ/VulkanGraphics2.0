...
void FrameBufferRenderPass::RebuildSwapChain(glm::ivec2 renderPassResolution, std::shared_ptr<Texture> RenderedTexture, std::shared_ptr<Texture> BloomTexture)
{
...
void FrameBufferRenderPass::Draw()
{
    ...
    vkCmdBindDescriptorSets(CommandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, frameBufferPipeline->ShaderPipelineLayout, 0, 1, &frameBufferPipeline->DescriptorSet, 0, nullptr);
