...
WireFrameRenderingPipeline::WireFrameRenderingPipeline() : GraphicsPipeline()
{
}

WireFrameRenderingPipeline::WireFrameRenderingPipeline(VulkanEngine& renderer, const VkRenderPass& renderPass) : GraphicsPipeline(renderer)
{
    CreateDescriptorSetLayout(renderer);
    CreateShaderPipeLine(renderer, renderPass);
}

WireFrameRenderingPipeline::~WireFrameRenderingPipeline()
{
}

void WireFrameRenderingPipeline::CreateDescriptorSetLayout(VulkanEngine& renderer)
{
...
void WireFrameRenderingPipeline::UpdateGraphicsPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass)
{
