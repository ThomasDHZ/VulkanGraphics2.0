...
ForwardRenderering2DPipeline::ForwardRenderering2DPipeline() : GraphicsPipeline()
{
}

ForwardRenderering2DPipeline::ForwardRenderering2DPipeline(VulkanEngine& renderer, const VkRenderPass& renderPass, int PipelineBitFlags) : GraphicsPipeline(renderer)
{
    CreateDescriptorSetLayout(renderer);
    CreateShaderPipeLine(renderer, renderPass, PipelineBitFlags);
}

ForwardRenderering2DPipeline::~ForwardRenderering2DPipeline()
{
}

void ForwardRenderering2DPipeline::CreateDescriptorSetLayout(VulkanEngine& renderer)
{
...
void ForwardRenderering2DPipeline::CreateShaderPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass, int PipelineBitFlags)
{
...
void ForwardRenderering2DPipeline::UpdateGraphicsPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass, int PipelineBitFlags)
{
