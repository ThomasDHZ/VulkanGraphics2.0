...
RayTracingGraphicsPipeline::RayTracingGraphicsPipeline(std::shared_ptr<VulkanEngine> engine) : GraphicsPipeline()
{
    ...
    vkGetPhysicalDeviceProperties2(EnginePtr::GetEnginePtr()->PhysicalDevice, &deviceProperties2);

    accelerationStructureFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR;
    VkPhysicalDeviceFeatures2 deviceFeatures2{};
    deviceFeatures2.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
    deviceFeatures2.pNext = &accelerationStructureFeatures;
    vkGetPhysicalDeviceFeatures2(EnginePtr::GetEnginePtr()->PhysicalDevice, &deviceFeatures2);
}
