...
CubeMapRenderingPipeline::CubeMapRenderingPipeline(const VkRenderPass& renderPass) : GraphicsPipeline()
{
    SetUpDescriptorPool();
...
void CubeMapRenderingPipeline::SetUpDescriptorPool()
{
...
void CubeMapRenderingPipeline::SetUpDescriptorLayout()
{
...
void CubeMapRenderingPipeline::SetUpDescriptorSets()
{
    ...
    DescriptorList.emplace_back(EnginePtr::GetEnginePtr()->AddTextureDescriptorSet(10, DescriptorSet, TextureBufferInfo));
    vkUpdateDescriptorSets(VulkanPtr::GetDevice(), static_cast<uint32_t>(DescriptorList.size()), DescriptorList.data(), 0, nullptr);
}

void CubeMapRenderingPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    std::vector<VkPipelineShaderStageCreateInfo> PipelineShaderStageList;
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/SkyboxTextureRendererVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/SkyboxTextureRendererFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
...
void CubeMapRenderingPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass)
{
