...
PBRRayTracedPipeline::PBRRayTracedPipeline() : RayTracingGraphicsPipeline()
{
}

PBRRayTracedPipeline::PBRRayTracedPipeline(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, AccelerationStructure& topLevelAS, std::shared_ptr<RenderedRayTracedColorTexture> RayTracedTexture) : RayTracingGraphicsPipeline(engine)
{
...
PBRRayTracedPipeline::~PBRRayTracedPipeline()
{
}

void PBRRayTracedPipeline::UpdateGraphicsPipeLine(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, AccelerationStructure& topLevelAS, std::shared_ptr<RenderedRayTracedColorTexture> RayTracedTexture)
{
...
void PBRRayTracedPipeline::SetUpDescriptorPool(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager)
{
    ...
    DescriptorPoolList.emplace_back(EnginePtr::GetEnginePtr()->AddDsecriptorPoolBinding(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, AssetManagerPtr::GetAssetPtr()->GetCubeMapBufferDescriptorCount()));
...
void PBRRayTracedPipeline::SetUpDescriptorLayout(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager)
{
    ...
    LayoutBindingInfo.emplace_back(DescriptorSetLayoutBindingInfo{ 13, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_ALL, AssetManagerPtr::GetAssetPtr()->GetCubeMapBufferDescriptorCount() });
...
void PBRRayTracedPipeline::SetUpDescriptorSets(std::shared_ptr<VulkanEngine> engine, std::shared_ptr<AssetManager> assetManager, AccelerationStructure& topLevelAS, std::shared_ptr<RenderedRayTracedColorTexture> RayTracedTexture)
{
...
void PBRRayTracedPipeline::SetUpPipeline(std::shared_ptr<VulkanEngine> engine)
{
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbrraygen.rgen.spv", VK_SHADER_STAGE_RAYGEN_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbrmiss.rmiss.spv", VK_SHADER_STAGE_MISS_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbrshadow.rmiss.spv", VK_SHADER_STAGE_MISS_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbrclosesthit.rchit.spv", VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbranyhit.rahit.spv", VK_SHADER_STAGE_ANY_HIT_BIT_KHR));
    ...
    ShaderList.emplace_back(EnginePtr::GetEnginePtr()->CreateShader("Shaders/pbranyhit1.rahit.spv", VK_SHADER_STAGE_ANY_HIT_BIT_KHR));
...
void PBRRayTracedPipeline::SetUpShaderBindingTable(std::shared_ptr<VulkanEngine> engine)
{
