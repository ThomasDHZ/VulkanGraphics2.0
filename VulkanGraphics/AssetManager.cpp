...
void AssetManager::Update()
{
    ...
    SceneData->UniformDataInfo.proj = LightManagerPtr::GetLightManagerPtr()->PointLightList[0]->lightViewCamera->GetProjectionMatrix();
    SceneData->UniformDataInfo.proj[1][1] *= -1;
    SceneData->UniformDataInfo.view = LightManagerPtr::GetLightManagerPtr()->PointLightList[0]->lightViewCamera->GetViewMatrix();
