...
LightDebugPipeline::LightDebugPipeline() : GraphicsPipeline()
{
}

LightDebugPipeline::LightDebugPipeline(const VkRenderPass& renderPass) : GraphicsPipeline()
{
...
void LightDebugPipeline::SetUpDescriptorBindings()
{
...
void LightDebugPipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    std::vector<VkPipelineShaderStageCreateInfo> PipelineShaderStageList;
    PipelineShaderStageList.emplace_back(CreateShader("shaders/LightDebugShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(CreateShader("shaders/LightDebugShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
...
void LightDebugPipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass)
{
