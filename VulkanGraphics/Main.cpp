...
private:
    ...
    struct TestMesh
    {
        ...
        void Update(VkDevice& device, VkExtent2D swapChainExtent, uint32_t currentImage)
        {
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("C:/Users/dotha/source/repos/VulkanGraphics/VulkanGraphics/Shaders/Testvert.spv");
        auto fragShaderCode = readFile("C:/Users/dotha/source/repos/VulkanGraphics/VulkanGraphics/Shaders/Testfrag.spv");
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        mesh.Update(device, swapChainExtent, currentImage);
    }
